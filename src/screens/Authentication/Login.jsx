...
<div className="login ">
  <div className='container login-container align-item:center  '>
  ...
  <Link to="/signup" className='text-red-800 text-[12px] text-center mt-3.5' > Dont have a account?  </Link>
      </div>

    <input className="login-button" type="submit" defaultValue="Log In" />
  </form>
  <div className="social-account-container">
    <span className="title">Or login in with</span>
