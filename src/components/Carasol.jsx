...
import cara from '../image/cara.jpg'
import caras from '../image/caras.jpg'
...
<div>
  ...
  <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
    ...
    <div className=" duration-700 ease-in-out" data-carousel-item>
      <img src={cara} className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
    </div>
    {/* Item 2 */}
    <div className="hidden duration-700 ease-in-out" data-carousel-item>
      <img src={caras} className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
    </div>
    {/* Item 3 */}
    <div className="hidden duration-700 ease-in-out" data-carousel-item>
